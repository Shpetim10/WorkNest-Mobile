...
import { ExpiredIcon } from '@/common/components/expired-icon';
...
export function LinkExpiredScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* Background Shadow Glows (Yellowish-Blue Theme from Session Expired) */}
      <View style={styles.backgroundContainer}>
        <View style={StyleSheet.absoluteFill}>
          {/* Upper Glow (Figma: #BEDBFF 30% and #F0B100 30%) */}
          <LinearGradient
            colors={['#BEDBFF4D', '#F0B1004D']}
            locations={[0.3, 0.7]}
